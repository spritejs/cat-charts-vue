<template>
  <header>
    <div class="logo">
      ...
      <img
        class="img-logo"
        src="https://p4.ssl.qhimg.com/d/inn/cb71616db557/cat-charts.png"
        alt="cat-charts"
      >
      <svg class="svg-cat" version="1.1" width="100px" height="132" viewBox="0 0 100 132">
        <path class="cat"></path>
      </svg>
    </div>
...
.cat {
  fill: #000;
  -webkit-animation: ani 2s infinite ease-out;
}
.home {
  width: 200px;
  position: absolute;
