<template>
  <div>
    <div class="desr">
      ...
      <a href="https://www.spritejs.com/q-charts/">QCharts</a> 封装的图表库，可以让用户以组件的形式组合出各种图表。如果你使用Js或者React，可以使用
      <a
        href="https://www.spritejs.com/q-charts/"
      >QCharts</a> 或
      <a href="https://www.spritejs.com/cat-charts-react/">CatCharts-React</a> ，使用微信小程序
